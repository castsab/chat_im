...
$dbss['name']='cpa';                  // Database name [mysql, postgre]. Note that the installation script cannot create a database for you!
$dbss['prfx']='cc';               // Table prefix for BLAB!IM tables, default 'bmf'
...
$site_to_bim='./chat_im/';         // URL or relative path from your main site to BLAB!IM, default: $site_to_bim='./blab_im/'; [must end with a trailing slash]
